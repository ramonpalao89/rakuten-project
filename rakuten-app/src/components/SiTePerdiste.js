...
import { retrieveMissedMovies } from '../logic/retrieve-missed-movies'
import { useDispatch, useSelector } from 'react-redux'
import { Link } from 'react-router-dom'

function SiTePerdiste() {
    const movieData = useSelector(state => state.missedMovies.missedMovies.data)
    const error = useSelector(state => state.missedMovies.error)
