...
import { retrieveEstrenosFamilia } from '../logic/retrieve-estrenos-familia'
import { useDispatch, useSelector } from 'react-redux'
import { Link } from 'react-router-dom'

function EstrenosFamilia() {
    const movieData = useSelector(state => state.moviesFamily.moviesFamily.data)
    const error = useSelector(state => state.moviesFamily.error)
...
export default EstrenosFamilia
